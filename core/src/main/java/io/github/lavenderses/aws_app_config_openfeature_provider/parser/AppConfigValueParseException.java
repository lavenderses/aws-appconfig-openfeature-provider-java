    ...
    public AppConfigValueParseException(
        ...
        super(
                /* message= */ String.format(
                        "%s. Response from AWS AppConfig: %s", errorMessage, response));

        this.response = response;
        this.errorMessage =
                String.format("%s. Response from AWS AppConfig: %s", errorMessage, response);
        this.evaluationResult = evaluationResult;
    }

    public AppConfigValueParseException(
            @NotNull final String response, @NotNull final EvaluationResult evaluationResult) {
        super(/* message= */ errorMessage(response));
